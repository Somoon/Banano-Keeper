...
///
extension TweetNaClExt on TNaCl {
  static int crypto_auth_hmacsha512(Uint8List out, Uint8List m, Uint8List k) {
    _crypto_auth(TNaCl.crypto_hash, 128, out, m, k);
    return 0;
  }
  ...
  static int _crypto_verify_64(
    ...
    return TNaCl._vn(x, xoff, y, yoff, 32);
  }
  ...
  static int crypto_sign_ed25519_sk_to_x25519_sk(
    ...
    TNaCl._crypto_hash_off(h, ed25519_sk, 0, 32);
  ...
  static int crypto_sign_ed25519_pk_to_x25519_pk(
    ...
    if (TNaCl._unpackneg(q, ed25519_pk) != 0) return -1;

    final y = q[1];

    // b = 1 + Yed
    TNaCl._A(a, TNaCl._gf1, y);
    // b = 1 - Yed
    TNaCl._Z(b, TNaCl._gf1, y);
    // b = inv(b)
    TNaCl._inv25519(b, 0, b, 0);
    // a = a * inv(b) i.e. a / b
    TNaCl._M(a, a, b);
    TNaCl._pack25519(z, a, 0);
  ...
  static int crypto_point_add(Uint8List out, Uint8List p1, Uint8List p2) {
    ...
    if (TNaCl._unpackneg(p, p1) != 0) return -1;
    if (TNaCl._unpackneg(q, p2) != 0) return -1;
